...
if [[ -n "${BF_JSON_JAR:-}" ]]; then
  java com.sun.tools.javac.Main -encoding UTF-8 -cp "$BF_JSON_JAR" -d out/tests app/src/main/java/com/blackapps/follow/ViewerVerifier.java app/src/main/java/com/blackapps/follow/ResponsePolicy.java tests/ViewerVerifierTest.java
  java -cp "$BF_JSON_JAR:out/tests" ViewerVerifierTest
  mkdir -p out/transport-tests
  java com.sun.tools.javac.Main -encoding UTF-8 -cp "$BF_JSON_JAR" -d out/transport-tests tests/transport/android/content/Context.java tests/transport/android/webkit/CookieManager.java tests/transport/com/blackapps/follow/Session.java tests/transport/com/blackapps/follow/Store.java app/src/main/java/com/blackapps/follow/InstagramClient.java app/src/main/java/com/blackapps/follow/ViewerVerifier.java app/src/main/java/com/blackapps/follow/ResponsePolicy.java app/src/main/java/com/blackapps/follow/RetryPolicy.java app/src/main/java/com/blackapps/follow/RelationLogic.java app/src/main/java/com/blackapps/follow/ProfileLinks.java app/src/main/java/com/blackapps/follow/RequestTrace.java tests/TransportTest.java
