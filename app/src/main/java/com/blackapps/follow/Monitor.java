...
public final class Monitor {
    ...
    private static String run(Context c,long onlyId,boolean force,boolean profileOnly) {
        ...
        try(Store store=new Store(c)) {
            ...
            InstagramClient client=new InstagramClient(c,owner,deadline,(kind,page,received,total)->progress=("followers".equals(kind)?"Takipçiler":"Takip edilenler")+": "+received+"/"+total+" kişi • sayfa "+page);
